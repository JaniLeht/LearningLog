...
const dbUrl =
  "mongodb+srv://mspagnolo-admin:" +
  password +
  "@cluster0.lxizv.mongodb.net/LearningLog?retryWrites=true&w=majority";
...
const notes_data = [
  { id_: 1, name: "basic routes", notes: "This is the basic route ..." },
  { id_: 2, name: "NPM install", notes: "npm is how you install packages" },
];
